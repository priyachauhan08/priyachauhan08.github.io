 ...
 * @return string|void
 */
function rvdx_theme_get_full_layout_classes( $classes = array() ) {
	$layout_classes = ! empty( rvdx_theme()->layout[ 'fullwidth' ][0]['content'] ) ? rvdx_theme()->layout[ 'fullwidth' ][0]['content'] : array();
	...
	$layout_classes = apply_filters( "rvdx-theme/wrapper/fullwidth_classes", $layout_classes );

	echo 'class="' . join( ' ', $layout_classes ) . '"';
}
